...
namespace StringSort
{
    ...
    //Purpose:- To sort strings according to the length of words
    class Program
    {
        ...
        //Author:- Pruthviraj Solanki (Knight)
        //Purpose:- A method that sorts a string according to the length of words
        ...
        // a label to allow us to easily loop back to the start if there are input issues
           ...
           // Console.WriteLine(nUnsortedLength);
            ...
            foreach (string sThisWord in sWord)
            {
                ...
                //Console.WriteLine(aUnsorted[nUnsortedLength]);
